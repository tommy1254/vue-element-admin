  ...
  <div>
    ...
    <el-table :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="disable" label="启用" width="60" align="center">
        <template scope="{row}">
          <el-link type="success" :underline="false" v-if="row.disable == '1'"
            ><i class="el-icon-check"></i>启用</el-link
          >
          <el-link type="danger" :underline="false" v-if="row.disable == '2'"
            ><i class="el-icon-close"></i>禁用</el-link
          >
        </template>
      </el-table-column>
